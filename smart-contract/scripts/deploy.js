...
const { createApplications } = require("./fake-data");
...
async function main() {
  ...
  const LicensePlaceContract = await hre.ethers.getContractFactory(
    "LicensePlace"
  );
  ...
  console.log(
    "License Place Contract deployed to: ",
    licensePlaceContract.address
  );
